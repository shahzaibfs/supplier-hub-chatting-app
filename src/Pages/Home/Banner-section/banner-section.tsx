...
const BannerSection = () => {
    ...
    return (
        <SectionLayout
            className={`${getMobileStyles(lg)?.section} ${getDesktopStyles(lg)?.section
                } banner__common__section`}
        >
            <Row
                gutter={8}
                className={`${getMobileStyles(lg)?.parent} ${getDesktopStyles(lg)?.parent
            ...
            >
                ...
                >
                    <Title
                        level={1}
                        className="chatting__app__heading__primary"
                        style={{ maxWidth: "20ch" }}
                    >
                    ...
                    <Paragraph
                        className="chatting__app__text__secondary"
                        style={{ maxWidth: "39ch" }}
                        strong
                    >
                    ...
                    <Paragraph style={{ maxWidth: "39ch" }} className="chatting__app__text__secondary">
                ...
                <Col
                    className={`${getMobileStyles(lg)?.svgParent
